...
exports.getAllComments = (req, res, _next) => { // Middleware permettant de récupérer tous les commentaires stockés dans la base de données
...
exports.getOnePostComments = (req, res, _next) => { // Récupération des commentaires d'un post 
...
exports.getOneComment = (req, res, _next) => { // Récupération d'un commentaire spécifique ainsi que de ses informations (dont son auteur)
...
exports.createComment = (req, res, _next) => { // Création d'un commentaire
...
exports.modifyComment = (req, res, _next) => { // Modification d'un commentaire
...
exports.deleteComment = (req, res, _next) => { // Suppression d'un commentaire à partir de son ID
	let id = req.params.id;
